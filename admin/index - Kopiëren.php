...
if(($session_duration>0 && !empty($session_expires) && mktime()>$session_expires) || empty($_SESSION['mpass_pass']) || empty($_SESSION['mname_name']) || (!in_array($_SESSION['mname_name'],$admin_name)) || ($_SESSION['mpass_pass'] <> $paswoord)) {
 ...
 <tr>
  ...
  <td width="1055" height="100%"><table width="107%" height="100%" align="center"><tr><td align="center"><p align="left">
	...
	<head>
		...
		<link rel="shortcut icon" href="../_images/kljgistel.ico">
...
$_SESSION['mpass_attempts'] = 0;
$_SESSION['mpass_session_expires'] = mktime()+$session_duration; ?></td></tr></table></td>
</tr>
</table>
  </body>
