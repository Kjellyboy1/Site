...
function map($print) {
	...
	if (isset($_POST['nieuw'])) {
        ...
        mysql_query("INSERT INTO Leden(voornaam,naam,fotos,dag,maand,jaar,adres,nr,postcode,gemeente,telefoon,email,position,visible) VALUES('$voornaam','$naam','$fotos','$dag','$maand','$jaar','$adres','$nr','$postcode','$gemeente','$telefoon','$email','$position','$visible')"); 
        mysql_close($db);
	...
	if (isset($_POST['profiel'])) {
		...
		mysql_query("UPDATE Leden SET adres='$adres' WHERE id='$id'");
		mysql_query("UPDATE Leden SET nr='$nr' WHERE id='$id'");
		...
		<tr>
		  <td colspan='2' valign='top'>
		    <table width='100%' align='left' border='0' cellspacing='0' cellpadding='1'>
			  ...
			  <tr>
				<td>
					<input class='input' type="text" name="voornaam" size="15"/>&nbsp;<input class='input' type="text" name="naam" size="40"/><br /><br />
				</td>
			  </tr>
			  <tr>
				<td>
			  ...
			  <tr>
				<td>
					<input class='input' type="text" name="adres" size="30"/>&nbsp;<input class='input' maxlength='4' type="text" name="nr" value="<?php echo $r[nr]; ?>" size="4"/>
				</td>
			  </tr>
			  <tr>
				<td>
					<input maxlength='4' class='input' type="text" name="postcode" size="4"/>&nbsp;<input class='input' type="text" name="gemeente" value="<?php echo $r[gemeente]; ?>" size="30"/><br /><br />
				</td>
			  </tr>
			  <tr>
				<td>
			  ...
			  <tr>
				<td>
					<input class='input' type="text" name="telefoon" size="30"/><br /><br />
				</td>
			  </tr>
			  <tr>
				<td>
			  ...
			  <tr>
				<td>
					<input class='input' type="text" name="email" size="58"/><br /><br /><br />
				</td>
			  </tr>
			  <tr>
				<td>
		...
		<tr>
		  <td colspan='2' valign='top'>
		    <table width='100%' align='left' border='0' cellspacing='0' cellpadding='1'>
			  ...
			  <tr>
				<td>
					<input class='input' type="text" name="voornaam" value="<?php echo $r[voornaam]; ?>" size="15"/>&nbsp;<input class='input' type="text" name="naam" value="<?php echo $r[naam]; ?>" size="40"/><br /><br />
				</td>
			  </tr>
			  <tr>
				<td>
